...
# 数据库备份远程路径
MYSQL_BACK_DIR=/home/backupmysql
...
echo "mysql backup begin at $(date '+%Y-%m-%d %H:%M:%S')"
...
BACKUP_RSYNC(){
    ...
    echo -e "$CGREEN 请输入 RSYNC 服务器数据存储路径 [ 默认为 /home/backupmysql ]: $CEND \c"
    read MYSQL_BACK_DIR
    RSYNC_DATA_DIR=${MYSQL_BACK_DIR:-/home/backupmysql}
